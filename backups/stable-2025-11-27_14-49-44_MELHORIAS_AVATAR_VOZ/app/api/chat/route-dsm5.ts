...
function getInitialAssessment(concern: string, message: string): string {
  ...
  return assessments[concern as keyof typeof assessments] || assessments.geral;
}
...
function getPracticalExercise(concern: string): string {
  ...
  return exercises[concern as keyof typeof exercises] || exercises.geral;
}
...
function getHomeworkAssignment(concern: string): string {
  ...
  return assignments[concern as keyof typeof assignments] || assignments.geral;
}
