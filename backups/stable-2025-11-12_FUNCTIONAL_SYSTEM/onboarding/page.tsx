            ...
            {steps.map((step, index) => (
              <div key={index} className="flex items-center">
                ...
                <span className={`ml-2 text-sm ${
                  index <= currentStep ? 'text-blue-600 font-semibold' : 'text-gray-700'
                }`}>
                  {step}
                </span>
          ...
          {currentStep === 0 && (
            <div className="text-center space-y-8">
              ...
              <div className="bg-blue-50 rounded-lg p-6 max-w-md mx-auto">
                ...
                <p className="text-xs text-gray-700 mt-2">- Dr. Ana Silva, CRP 06/12345</p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-100">
                  ...
                  <p className="text-gray-800">Protocolo TCC baseado em Aaron Beck com identificação automática de crenças disfuncionais</p>
                </div>

                <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-100">
                  <div className="text-4xl mb-4">🔒</div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">100% Seguro e Privado</h3>
                  <p className="text-gray-800">Criptografia end-to-end, dados protegidos por LGPD, sem compartilhamento com terceiros</p>
                </div>

                <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-100">
                  <div className="text-4xl mb-4">⏰</div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Disponível 24/7</h3>
                  <p className="text-gray-800">Acesso imediato ao suporte terapêutico, sem agendamentos ou filas de espera</p>
                </div>

                <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-100">
                  <div className="text-4xl mb-4">🎓</div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Baseado em Evidências</h3>
                  <p className="text-gray-800">Técnicas validadas cientificamente: Seta Descendente, Questionamento Socrático, Reestruturação Cognitiva</p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6">
                ...
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-green-600">✅</span>
                    <span className="text-gray-800">Técnica da Seta Descendente</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-green-600">✅</span>
                    <span className="text-gray-800">Questionamento Socrático</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-green-600">✅</span>
                    <span className="text-gray-800">Reestruturação Cognitiva</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-green-600">✅</span>
                    <span className="text-gray-800">Registro de Pensamentos</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-green-600">✅</span>
                    <span className="text-gray-800">Tarefas Terapêuticas</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-8">
              <div className="text-center">
                ...
                <p className="text-gray-800">Escolha o plano que melhor se adapta às suas necessidades</p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-gray-800 text-sm">7 dias grátis</p>
                  </div>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center gap-2">
                      <span className="text-green-600">✅</span>
                      <span className="text-gray-800">3 sessões por dia</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="text-green-600">✅</span>
                      <span className="text-gray-800">Todas as técnicas TCC</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="text-green-600">✅</span>
                      <span className="text-gray-800">Registro de pensamentos</span>
                ...
                <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-gray-800 text-sm">por mês</p>
                  </div>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center gap-2">
                      <span className="text-green-600">✅</span>
                      <span className="text-gray-800">Tudo do Premium</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="text-green-600">✅</span>
                      <span className="text-gray-800">Supervisão de psicólogo</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="text-green-600">✅</span>
                      <span className="text-gray-800">Relatórios para médicos</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="text-green-600">✅</span>
                      <span className="text-gray-800">Integração com clínicas</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          {currentStep === 3 && (
            <div className="space-y-8">
              <div className="text-center">
                ...
                <p className="text-gray-800">Configure o ClaraMente de acordo com suas preferências</p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-800 text-sm mt-2">Escolha o idioma que você se sente mais confortável</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 text-sm mt-2">Selecione o perfil que mais lhe transmite confiança</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 text-sm mt-2">Nossa base é TCC, mas você pode personalizar o estilo</p>
                  </div>
                </div>
