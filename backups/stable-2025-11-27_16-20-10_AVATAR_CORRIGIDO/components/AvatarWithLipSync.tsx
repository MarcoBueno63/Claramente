...
export default function AvatarWithLipSync({
  ...
  useEffect(() => {
    if (mode !== 'canvas' || !canvasRef.current) {
      console.log('⚠️ Canvas não disponível:', { mode, hasCanvas: !!canvasRef.current });
      return;
    }
    ...
    console.log('✅ Iniciando renderização do canvas');
    ...
    img.onload = () => {
      console.log('✅ Imagem carregada:', avatarImage);
      const animate = () => {
