...
export default function EmotionalKeyboard({
  ...
  return (
    <>
      ...
      {!isOpen && (
        <motion.button
          onClick={() => typeof setIsOpen === 'function' ? setIsOpen() : setInternalIsOpen(true)}
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
              ...
              <button
                onClick={() => typeof setIsOpen === 'function' ? setIsOpen() : setInternalIsOpen(false)}
