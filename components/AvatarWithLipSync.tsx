  ...
  return (
    <motion.div className={`relative ${className}`}
      ...
      <motion.div className={`relative rounded-lg overflow-hidden transition-all duration-500 bg-gradient-to-br ${emotionStyle.bgGradient}`}
        ...
        {isSpeaking && (
          <div className="absolute top-1 left-1 z-30 flex gap-2">
            <button
              className="px-2 py-1 rounded bg-blue-500 text-white text-xs shadow hover:bg-blue-700"
              onClick={() => {
            ...
            >⏸ Pausar</button>
            <button
              className="px-2 py-1 rounded bg-green-500 text-white text-xs shadow hover:bg-green-700"
              onClick={() => {
                if (audioRef.current) {
                  audioRef.current.currentTime = 0;
            ...
            >▶️ Retomar</button>
            <button
              className="px-2 py-1 rounded bg-gray-500 text-white text-xs shadow hover:bg-gray-700"
              onClick={() => {
                if (audioRef.current) {
                  audioRef.current.pause();
                  audioRef.current.currentTime = 0;
